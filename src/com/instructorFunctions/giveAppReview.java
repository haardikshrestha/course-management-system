...
public class giveAppReview {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					giveAppReview window = new giveAppReview();
	...
	private void initialize() {
		...
		frmStudentGive.setIconImage(Toolkit.getDefaultToolkit().getImage(giveAppReview.class.getResource("/com/icons/icons8-classroom-85.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(giveAppReview.class.getResource("/com/icons/icons8-star-filled-30.png")));
